#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Alizada
...
logo = """
    ...
    \033[1;94m::▒▒▒▒▒▒█▒▒▒█▒█▒█▒▒▒█▒█▒▒▒▒▒▒▒▒▒▒::::      
   \033[1;95m:::▒▒▒▒▒▒███▒███▒███▒███▒▒▒▒▒▒▒▒▒▒:::::         
  \033[1;96m::♧♧♧♧♧♧♧♧♧♧\033[1;91mImo NUM\033[1;96m♧♧♧♧♧♧♧♧♧♧▒▒▒▒▒▒▒::::        
...
\033[1;94mFacebook\033[1;91m: \033[1;91mFB.COM/RESULT0
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:alizada
	    time.sleep(2)
            loop = 'false'
        else:
